...
- Remove the ability to focus on elements inside the modal if it is closed or not visible.

## 1.7.1 - 2025-12-02

- Improve selector `FOCUSABLE_ELEMENTS` in Modal class to prevent keyboard navigation issues.
